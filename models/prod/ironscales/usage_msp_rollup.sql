...
second_tier_msp as (
    ...
    Email_Protect_of_Licenses,
    Email_Protect_NFR_of_Licenses,
    Complete_Protect_of_Licenses,
    Complete_Protect_NFR_of_Licenses,
    Core_of_Licenses,
    Core_NFR_of_Licenses,
    Ironscales_Protect_of_Licenses,
    Ironscales_Protect_NFR_of_Licenses,
    PST_of_Licenses,
    PST_NFR_of_Licenses,
    Starter_of_Licenses,
    Premium_Content_of_Licenses,
    -- Premium_Content_NINJIO_of_Licenses,
    -- Premium_Content_Cybermaniacs_of_Licenses,
    Account_Takeover_of_Licenses,
    Incident_Management_of_Licenses,
    Multi_Tenant_of_Licenses,
    ST_Bundle_of_Licenses,
    ST_Plus_Bundle_of_Licenses,
    SAT_of_Licenses,
    SAT_Suite_of_Licenses,
    SAT_Suite_NFR_of_Licenses,
    DMARC_Management_of_Licenses
    from main_with_revenue s
...
direct_msp as (
    ...
    SAT_Suite_NFR_of_Licenses,
    DMARC_Management_of_Licenses
    from main_with_revenue_direct s
    left join global_tenant_history g on s.FIRST_LAYER_ID = g.tenant_global_id
    -- where ltp_type = 'msp' 
    -- and s.partner_pricing = true
    -- group by 1,2,3,4
