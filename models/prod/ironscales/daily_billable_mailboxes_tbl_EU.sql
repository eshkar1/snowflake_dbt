...
OBJECT_CONSTRUCT(
    ...
    CASE WHEN sltp_bill.ST_Plus_Bundle THEN 'SIMULATION_AND_TRAINING_BUNDLE_PLUS_QUANTITY' ELSE NULL END, CASE WHEN sltp_bill.ST_Plus_Bundle THEN ifnull(ST_Plus_Bundle_of_Licenses,0) ELSE NULL END,
