...
--     -- S&T Plus Bundle
--     CASE WHEN sltp_bill.ST_Bundle_Plus THEN 'SIMULATION_AND_TRAINING_BUNDLE_PLUS' ELSE NULL END, CASE WHEN sltp_bill.ST_Bundle_Plus THEN ST_Bundle_Plus ELSE NULL END,
--     CASE WHEN sltp_bill.ST_Bundle_Plus THEN 'SIMULATION_AND_TRAINING_BUNDLE_PLUS_QUANTITY' ELSE NULL END, CASE WHEN sltp_bill.ST_Bundle_Plus THEN ifnull(ST_Bundle_Plus_of_Licenses,0) ELSE NULL END,
