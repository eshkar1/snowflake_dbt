WITH global_tenant_history AS (
    SELECT * FROM {{ ref('current_global_tenant_ltp_non_hwm') }}
),
...
extracted AS (
    SELECT
        ...
        g.dmarc_ironscales_plan,                                                     -- added
        g.dmarc_ironscales_plan_name,                                                -- added
        g.NOT_NFR_PARTNER
...
SELECT
    ...
    a.dmarc_ironscales_plan,                                                         -- added
    a.dmarc_ironscales_plan_name,                                                    -- added
    a.not_nfr_partner
