...
-- Non NFR Plans --
case 
WHEN g.partner_pricing = FALSE and plan_name = 'Email Protect' and quantity >= 7500 then (1000 * EP_1) + ((3500-1000)* EP_1000) + ((7500 - 3500) * EP_3500) + ((quantity - 7500)  * EP_7500)
WHEN g.partner_pricing = FALSE and plan_name = 'Email Protect' and quantity >= 3500 then (1000 * EP_1) + ((3500-1000)* EP_1000) + ((quantity - 3500) * EP_3500)
WHEN g.partner_pricing = FALSE and plan_name = 'Email Protect' and quantity >= 1000 then (1000 * EP_1) + (quantity - 1000) * EP_1000
WHEN g.partner_pricing = FALSE and plan_name = 'Email Protect' and quantity < 1000 then quantity * EP_1

WHEN g.partner_pricing = FALSE and plan_name = 'Core' and quantity >= 7500 then (1000 * CORE_1) + ((3500-1000)* CORE_1000) + ((7500 - 3500) * CORE_3500) + ((quantity - 7500)  * CORE_7500)
WHEN g.partner_pricing = FALSE and plan_name = 'Core' and quantity >= 3500 then (1000 * CORE_1) + ((3500-1000)* CORE_1000) + ((quantity - 3500) * CORE_3500)
WHEN g.partner_pricing = FALSE and plan_name = 'Core' and quantity >= 1000 then (1000 * CORE_1) + (quantity - 1000) * CORE_1000
WHEN g.partner_pricing = FALSE and plan_name = 'Core' and quantity < 1000 then quantity * CORE_1
-- end
WHEN g.partner_pricing = FALSE and plan_name = 'IRONSCALES Protect' and quantity >= 7500 then (1000 * IP_1) + ((3500-1000)* IP_1000) + ((7500 - 3500) * IP_3500) + ((quantity - 7500)  * IP_7500)
WHEN g.partner_pricing = FALSE and plan_name = 'IRONSCALES Protect' and quantity >= 3500 then (1000 * IP_1) + ((3500-1000)* IP_1000) + ((quantity - 3500) * IP_3500)
WHEN g.partner_pricing = FALSE and plan_name = 'IRONSCALES Protect' and quantity >= 1000 then (1000 * IP_1) + (quantity - 1000) * IP_1000
WHEN g.partner_pricing = FALSE and plan_name = 'IRONSCALES Protect' and quantity < 1000 then quantity * IP_1

WHEN g.partner_pricing = FALSE and plan_name = 'Complete Protect' and quantity >= 7500 then (1000 * CP_1) + ((3500-1000)* CP_1000) + ((7500 - 3500) * CP_3500) + ((quantity - 7500)  * CP_7500)
WHEN g.partner_pricing = FALSE and plan_name = 'Complete Protect' and quantity >= 3500 then (1000 * CP_1) + ((3500-1000)* CP_1000) + ((quantity - 3500) * CP_3500)
WHEN g.partner_pricing = FALSE and plan_name = 'Complete Protect' and quantity >= 1000 then (1000 * CP_1) + (quantity - 1000) * CP_1000
WHEN g.partner_pricing = FALSE and plan_name = 'Complete Protect' and quantity < 1000 then quantity * CP_1

WHEN g.partner_pricing = FALSE and plan_name = 'Phishing Simulation and Training' and quantity >= 7500 then (1000 * PST_1) + ((3500-1000)* PST_1000) + ((7500 - 3500) * PST_3500) + ((quantity - 7500)  * PST_7500)
WHEN g.partner_pricing = FALSE and plan_name = 'Phishing Simulation and Training' and quantity >= 3500 then (1000 * PST_1) + ((3500-1000)* PST_1000) + ((quantity - 3500) * PST_3500)
...
where
    ...
    and ltp not in ('US-11100','US-733','EU-25','EU-49000','EU-51541') -- exclude ofek & pax8
group by
    g.date_recorded,
    root,   
    plan_name,
